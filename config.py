...
class ChannelConfig:
    ...
    BLACKJACK_CHANNEL_ID = 1489005804110610663
    BALANCE_LOG_CHANNEL_ID = 1480300433590194207
    ADMIN_PANEL_CHANNEL_ID = 1489141185233686568
    ADMIN_LOG_CHANNEL_ID = 1489148175574110238
...
class Config:
    ...
    BLACKJACK_CHANNEL_ID = CHANNELS.BLACKJACK_CHANNEL_ID
    BALANCE_LOG_CHANNEL_ID = CHANNELS.BALANCE_LOG_CHANNEL_ID
    ADMIN_PANEL_CHANNEL_ID = CHANNELS.ADMIN_PANEL_CHANNEL_ID
    ADMIN_LOG_CHANNEL_ID = CHANNELS.ADMIN_LOG_CHANNEL_ID
